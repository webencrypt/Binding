/* Benchmark driver for unmodified SNOVA-24_5_4 reference. */
...
#include "snova.h"
/* Avoid project-wide api.h conflict; declare SNOVA NIST API directly. */
...
extern void randombytes_init(unsigned char* entropy, unsigned char* pers, int strength);
...
int main(void) {
    ...
    printf("=== SNOVA-24_5_4 baseline benchmark ===\n");
