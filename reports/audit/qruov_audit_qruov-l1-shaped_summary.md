# QR-UOV-shape audit (tier qruov-l1-shaped, suite qruov-fast-v1)

`N_SEEDS=100`, `n=64`, `m=32`, `q=31`, `d_g=4`, family-wise α=0.001, Bonferroni threshold=6.67e-05.
...
|---|---:|---:|---:|---:|---:|
| `qruov_baseline` | 32.00 | 64.00 | 1 | 0.645 | 0.118 |
| `qruov_synth_sparse_g` | 32.00 | 64.00 | 0.782 | 0.112 | 0.507 |
| `qruov_synth_pinned_g` | 32.00 | 64.00 | 3.52e-20 | 0.358 | 2.61e-59 |
